...
export async function GET(
  ...
  try {
    ...
    // Get boat rental listing with service and i18n info
    ...
    if (listingError || !listing) {
      console.error('Boat rental listing not found:', listingError);
      return NextResponse.json(
        { error: 'Boat rental listing not found' },
        { status: 404 }
      )
    }
    ...
    console.error('Error in boat rental API:', error)
    return NextResponse.json(
