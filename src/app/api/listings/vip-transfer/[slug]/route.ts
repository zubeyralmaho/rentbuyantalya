...
export async function GET(
  ...
  try {
    ...
    // Get VIP transfer listing with service and i18n info
    ...
    if (listingError || !listing) {
      console.error('VIP transfer listing not found:', listingError);
      return NextResponse.json(
        { error: 'VIP transfer listing not found' },
        { status: 404 }
      )
    }
    ...
    console.error('Error in VIP transfer API:', error)
    return NextResponse.json(
