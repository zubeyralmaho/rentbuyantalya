...
export default function FAQ() {
  ...
  return (
    <section className="py-12 lg:py-16" style={{background: 'var(--dark-bg)'}}>
      <div className="container-custom">
        ...
        <div className="max-w-4xl mx-auto">
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <div className="text-gray-500">Henüz FAQ eklenmemiş.</div>
            </div>
          ) : (
          ...
          <div className="text-center mt-12 p-8 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP || '905071564700'}?text=Merhaba, FAQ sayfasından geliyor ve soru sormak istiyorum.`}
